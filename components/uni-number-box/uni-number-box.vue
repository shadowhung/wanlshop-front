...
<script>
	/**
	 * NumberBox 數字輸入框
	 * @description 带加减按钮的數字輸入框
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=31
	 * @property {Number} value 輸入框当前值
	 * @property {Number} min 最小值
	 * @property {Number} max 最大值
	 * @property {Number} step 每次点击改变的間隔大小
	 * @property {Boolean} disabled = [true|false] 是否為禁用状态
	 * @event {Function} change 輸入框值改变时触發的事件，參數為輸入框当前的 value
	 */
