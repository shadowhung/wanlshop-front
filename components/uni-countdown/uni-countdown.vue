<template>
	<view class="uni-countdown">
		...
		<text v-if="showDay" :style="{ color: splitorColor }" class="uni-countdown__splitor">日</text>
...
<script>
	 ...
	 * @property {Boolean} showDay = [true|false] 是否顯示天數
	 * @property {Boolean} showColon = [true|false] 是否以冒號為分隔符
	 * @property {String} splitorColor 分割符號颜色
	 * @event {Function} timeup 倒計时时間到触發事件
