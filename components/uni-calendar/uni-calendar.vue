		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			<view v-if="!insert" class="uni-calendar__header uni-calendar--fixed-top">
				<view class="uni-calendar__header-btn-box" @tap="close">
					<text class="uni-calendar__header-text uni-calendar--fixed-width">キャンセル</text>
				</view>
				<view class="uni-calendar__header-btn-box" @tap="confirm">
					<text class="uni-calendar__header-text uni-calendar--fixed-width">決定する</text>
				</view>
			</view>
...
<script>
	...
	/**
	 * Calendar 日曆
	 * @description 日曆組件可以查看日期，选择任意范围内的日期，打点操作。常用场景如：酒店日期預訂、火车机票选择購买日期、上下班打卡等
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=56
	 * @property {String} date 自定义当前时間，默認為今天
	 * @property {Boolean} lunar 顯示農曆
	 * @property {String} startDate 日期选择范围-開始日期
	 * @property {String} endDate 日期选择范围-結束日期
	 * @property {Boolean} range 范围选择
	 * @property {Boolean} insert = [true|false] 插入模式,默認為false
	 * 	@value true 弹窗模式
	 * 	@value false 插入模式
	 * @property {Boolean} clearDate = [true|false] 弹窗模式是否清空上次选择內容
	 * @property {Array} selected 打点，期待格式[{date: '2019-06-27', info: '簽到', data: { custom: '自定义信息', name: '自定义消息頭',xxx:xxx... }}]
	 * @property {Boolean} showMonth 是否选择月份為背景
	 * @event {Function} change 日期改变，`insert :ture` 时生效
	 * @event {Function} confirm 確認选择`insert :false` 时生效
	 * @event {Function} monthSwitch 切换月份时触發
