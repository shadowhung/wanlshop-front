...
<script>
	...
	/**
	 * LoadMore 加載更多
	 * @description 用於列表中，做滚動加載使用，展示 loading 的各种状态
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=29
	 * @property {String} status = [more|loading|noMore] loading 的状态
	 * 	@value more loading前
	 * 	@value loading loading中
	 * 	@value noMore 没有更多了
	 * @property {Number} iconSize 指定圖标大小
	 * @property {Boolean} iconSize = [true|false] 是否顯示 loading 圖标
	 * @property {String} iconType = [snow|circle|auto] 指定圖标样式
	 * 	@value snow ios雪花加載样式
	 * 	@value circle 安卓唤醒加載样式
	 * 	@value auto 根據平台自動选择加載样式
	 * @property {String} color 圖标和文字颜色
	 * @property {Object} contentText 各状态文字说明，值為：{contentdown: "引き上げて詳細を表示",contentrefresh: "読み込み中...",contentnomore: "これ以上のデータはありません"}
	 * @event {Function} clickLoadMore 点击加載更多时触發
	 */
	export default {
		name: 'UniLoadMore',
		props: {
