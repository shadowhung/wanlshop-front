<template>
	<view class="bank-item" :style="bankThem" style="background-image: linear-gradient(45deg, #0081ff, #1cbbb4);">
		<!-- #ifndef MP -->
		...
		<view class="bank-head">
			...
			<view class="bank-info">
				...
				<text class="card-type">{{bankName2}}</text>
			</view>
		</view>
...
<script>
	export default {
		...
		props: {
			...
			bankName2: { type: String, required: true},
			cardType: { type: String, default: '銀行帳戶' },
