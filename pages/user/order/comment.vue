	...
	<view class="wanl-comment">
		...
		<view class="subject margin-lr-bj bg-white radius-bock margin-bottom-bj" v-for="(item, index) in goodsList" :key="item.id">
			...
			<view class="comment padding-lr-bj padding-top-bj">
				<view class="comment-title">商品評価</view>
			...
			<view class="describe cu-form-group margin-bj radius-bock padding-bj">
				<textarea maxlength="-1" v-model="item.comment" placeholder="評価中の製品~"></textarea>
			</view>
			<view class=""></view>
		...
		<view class="wanlian cu-bar tabbar foot flex flex-direction"><button @tap="addData()" class="cu-btn wanl-bg-orange lg">コメントを投稿</button></view>
	</view>
</template>
