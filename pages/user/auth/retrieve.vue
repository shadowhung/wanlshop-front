<template>
	<view>
		<view class="auth">
			<view class="wanl-title">アカウントのパスワードを取得する</view>
			<form @submit="formSubmit">
				<view class="auth-group radius-bock bg-gray wlian-grey-light">
					<input 
						placeholder="取得した携帯電話番号" 
						type="number"
						maxlength="15" 
						confirm-type="next" 
				...
				<view class="auth-button flex flex-direction">
					<button class="cu-btn bg-orange sl radius-bock" form-type="submit" :disabled="submitDisabled">次のステップ</button>
				</view>
			</form>
		</view>
