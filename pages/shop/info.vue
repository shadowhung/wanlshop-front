	...
	<view class="wanl-shop">
		...
		<view class="shop_synopsis bg-white">
			<view class="margin-left-bj shopuser">
				...
				<view class="">
					<view class="text-df">{{shopData.shopname || 'ロードの中...'}}</view>
					<view class="wanl-gray text-min">ファンの数 {{shopData.like}}</view>
			...
			<view class="margin-right-bj cu-btn round wanl-bg-orange margin-top"  @tap="follow">
				<text v-if="shopData.follow">すでに關の註</text>
				<view v-else><text class="wlIcon-yiguanzhu1"></text>  お気に入り</view>
			</view>
		</view>
		<view class="shop_info bg-white margin-top-bj padding-lr-bj">
			<view class="padding-tb-bj solid-bottom"> 店鋪介紹 </view>
		</view>
